...
agente_focado = Agent(
    model=OpenRouterModel("openai/gpt-4o-mini"),
    system_prompt=(
        "Identifique o tipo de texto (artigo acadêmico, relatório de pesquisa, revisão sistemática, etc.) e verifique se ele de fato possui natureza científica. Caso contrário, indique claramente que o texto não é científico."
        "Você analisa textos científicos e extrai as conclusões principais."
        "Seja objetivo e preciso. Use linguagem técnica adequada."
        "Não opine sobre o mérito da pesquisa — extraia o que está no texto."
